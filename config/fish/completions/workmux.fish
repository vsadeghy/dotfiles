...
complete -c workmux -n "__fish_workmux_using_subcommand add" -l pr -d 'Pull request number or full GitHub or GitHub Enterprise pull request URL to checkout' -r
