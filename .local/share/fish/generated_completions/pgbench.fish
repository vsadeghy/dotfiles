...
complete -c pgbench -s 2 --description 'T} T{ << T}:T{ integer bitwise shift left T}:T{ 1 << 2 T}:T{ 4 T} T{ >> T}:T{…'
complete -c pgbench -o '2.0' --description 'T} Built-In Functions.'
complete -c pgbench -o 5817877081768721676 --description 'T} T{ hash_fnv1a(a [, seed ] ) T}:T{ integer T}:T{ m[blue]FNV-1a hashm[] T}:T…'
complete -c pgbench -o 7793829335365542153 --description 'T} T{ hash_murmur2(a [, seed ] ) T}:T{ integer T}:T{ m[blue]MurmurHash2 hashm…'
