...
.br
--create-slot' --description 'This option causes creation of a replication slot named by the --slot option …'
...
complete -c pg_basebackup -l slot --description 'option before starting the backup.'
